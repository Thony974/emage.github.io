...
<div class="services_intro" data-aos="fade-up" data-aos-duration="2000">
    <h1 class="services_intro_title red">Mon accompagnement <br>Souffle, Clarté et Structure</h1>
    <h2 class="subtitle yellow">Un chemin progressif pour retrouver de la fluidité</h2>
    <p>Mon accompagnement ne se résume pas à des prestations. C’est un véritable <b class="green_forest">parcours évolutif</b>, pensé pour vous accompagner avec respect, douceur et stratégie, vers plus de clarté, de souffle et d’impact durable.</p>
